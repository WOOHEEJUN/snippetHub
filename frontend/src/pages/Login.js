      ...
      <div className="login-card">
        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          <div className="d-grid gap-2">
            <a href="https://snippethub-alb-120890630.ap-northeast-2.elb.amazonaws.com/oauth2/authorization/kakao" className="btn social-login-btn kakao-btn">
              <i className="bi bi-chat-fill me-2"></i> 카카오로 로그인
            </a>
            <a href="https://snippethub-alb-120890630.ap-northeast-2.elb.amazonaws.com/oauth2/authorization/google" className="btn social-login-btn google-btn">
